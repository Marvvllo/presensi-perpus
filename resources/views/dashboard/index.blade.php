<x-layout>
  <section class="flex flex-row justify-between px-4 py-2">
    ...
    <a class="flex flex-row gap-2 items-center rounded-md p-1 text-primary text-xl outline outline-1 outline-primary hover:bg-primary hover:text-white transition" href="#">
  ...
  <!-- Absensi Terbaru -->
  <section class="px-4">
    <h2 class="font-medium text-2xl">Beranda</h2>
  </section>
</x-layout>